...
#         current_time = datetime.now()
#         current_time_formatted = current_time.strftime("%Y_%m_%d_%H_%M_%S")
#         cv2.imwrite('./Captured_images/img_{}.jpg'.format(current_time_formatted), frame)
#         print("Captured")
#     # print(wait_key)
#     # #if cv2.waitKey(1):
#     # print(ord('c'))
#     # if 0xFF == ord('q'):
#     #     break
#     # elif 0xFF == ord('c'): # Key to capture an image
#     #     current_time = datetime.now()
#     #     current_time_formatted = current_time.strftime("%H_%M_%S_%d_%m_%Y")
#     #     cv2.imwrite('./Captured_images/img_{}.jpg'.format(current_time_formatted), frame)
#     #     print("Captured")
